...
INSERT INTO opticsculdampolla.supplier(nif, name, street, street_number, city, postal_code, country, phone_number) VALUES ('A12345B', 'supplier Song', 'carrer Pujades', 32, 'Barcelona', 08001,'Spain',  672301234);
...
INSERT INTO opticsculdampolla.glasses(brand_id, prescription, frame_type, color, glass_color, price)
...
INSERT INTO opticsculdampolla.costumer(name, street, street_number, city, postal_code, country, phone_number)
VALUES ('Alex', 'Aragon street', 11, 'Barcelona', 08012, 'Spain', 654321689);
INSERT INTO opticsculdampolla.costumer(name, street, street_number, city, postal_code, country, phone_number, recommender_costumer_id)
